    ...
    if user_id in admin_id:
        ...
        if len(command) > 2:
            ...
            if user_to_add not in allowed_user_ids:
                ...
                response = "Usᴇʀ Aʟʀᴇᴀᴅʏ Exɪsᴛ 🤦‍♂️."
        else:
            response = "Pʟᴇᴀsᴇ Sᴘᴇᴄɪғʏ ᴀ Usᴇʀ ID Aɴᴅ Tʜᴇ Dᴜʀᴀᴛɪᴏɴ (e.g., 1hour, 2days, 3weeks, 4months) Tᴏ Aᴅᴅ 😘."
    else:
        response = "Yᴏᴜ Hᴀᴠᴇ Nᴏᴛ Pᴜʀᴄʜᴀsᴇᴅ Yᴇᴛ Pᴜʀᴄʜᴀsᴇ Nᴏᴡ Fʀᴏᴍ:- @SIDIKI_MUSTAFA_47."
...
def remove_user(message):
    ...
    if user_id in admin_id:
        ...
        if len(command) > 1:
            ...
            response = '''Pʟᴇᴀsᴇ Sᴘᴇᴄɪғʏ A Usᴇʀ Iᴅ Tᴏ Rᴇᴍᴏᴠᴇ. 
✅ Usage: /remove <userid>'''
    else:
        response = "Yᴏᴜ Hᴀᴠᴇ Nᴏᴛ Pᴜʀᴄʜᴀsᴇᴅ Yᴇᴛ Pᴜʀᴄʜᴀsᴇ Nᴏᴡ Fʀᴏᴍ:- @SIDIKI_MUSTAFA_47 🙇."
...
def clear_logs_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "Yᴏᴜ Hᴀᴠᴇ Nᴏᴛ Pᴜʀᴄʜᴀsᴇᴅ Yᴇᴛ Pᴜʀᴄʜᴀsᴇ Nᴏᴇ Fʀᴏᴍ :- @SIDIKI_MUSTAFA_47 ❄."
    bot.reply_to(message, response)
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < COOLDOWN_TIME:
                response = "You Are On Cooldown ❌. Pʟᴇᴀsᴇ Wᴀɪᴛ 10sᴇᴄ Tᴏ Usᴇ Tʜᴇ /bgmi Cᴏᴍᴍᴀɴᴅ ᴀɢᴀɪɴ."
                bot.reply_to(message, response)
                return
        ...
        response = ("🚫 Uɴᴀᴛʜᴏʀɪᴢᴇᴅ Aᴄᴄᴇss! 🚫\n\nOops! Iᴛ Sᴇᴇᴍs Lɪᴋᴇ Yᴏᴜ Dᴏɴ'ᴛ Hᴀᴠᴇ Pᴇʀᴍɪssɪᴏɴ Tᴏ Usᴇ Tʜᴇ /bgmi Cᴏᴍᴍᴀɴᴅ. DM TO BUY ACCESS:- @SIDIKI_MUSTAFA_47")
...
💥 /mylogs : Tᴏ Cʜᴇᴄᴋ Yᴏᴜʀ Rᴇᴄᴇɴᴛ Aᴛᴛᴀᴄᴋs.
💥 /plan : Cʜᴇᴄᴋᴏᴜᴛ Oᴜʀ Bᴏᴛɴᴇᴛ Rᴀᴛᴇs.
